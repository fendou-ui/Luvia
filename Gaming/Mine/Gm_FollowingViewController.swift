//
//  Gm_FollowingViewController.swift
//  Gaming

import UIKit
import SnapKit

class Gm_FollowingViewController: UIViewController {
    
    // MARK: - Data
    
    private var gm_followingList: [Gm_FollowModel] = []
    ...
    private func gm_loadData() {
        gm_followingList = Gm_FollowStorage.shared.gm_getFollowingList()
        gm_updateEmptyState()
        gm_tableView.reloadData()
    }
    
    private func gm_updateEmptyState() {
        let isEmpty = gm_followingList.isEmpty
...
extension Gm_FollowingViewController: UITableViewDelegate, UITableViewDataSource {
    
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return gm_followingList.count
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let model = gm_followingList[indexPath.row]
